            ...
            <div class="items">
                <div class="title">
                    ...
                    <form method="post">
                        ...
                        <button href="update_item.php">All</button>
                    </form>
                </div>
                <div class="table">
                    <table class="display1">
                        ...
                        <td style="width: 150px;">' . $data[0] . '</td>
                        <td style="width: 80px;">' . $data[2] . '</td>
                        <td style="width: 120px;">' . $data[3] . '</td>
                    ...
                    <input type="submit" name="update_item" value="Update">
                        ...
                        <input type="submit" name="remove_item" value="Remove">
                                    ...
                                    echo '<span class="dang" style="color: red;">Cannot remove item</span>';
                                }
