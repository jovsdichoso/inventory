        ...
        <div class="right">
            <div class="items">
                ...
                echo '<form action="function.php" method="post">
                    ...
                    <input type="text" name="category" placeholder="Category" value="' . $_POST['category'] . '" readonly><br>
                    <label>Quantity</label>
                    <input type="text" name="quantity" placeholder="Quantity" value="' . $_POST['quantity'] . '" readonly><br>
                    <label>Expiration Date</label>
                    <input type="date" name="expiry" placeholder="Expiration Date" value="' . $_POST['expiry'] . '"><br>
                    <label>Description</label>
                    <input type="text" name="description" placeholder="Description" value="' . $_POST['description'] . '" readonly>
                    <input type="submit" name="update_expiration" value="Set Expiration">
                </form>';
                ?>
</body>
